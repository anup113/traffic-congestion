        ...
        <div class="container">
          ...
          <div id="collapsable-nav" class="collapse navbar-collapse">
           <ul id="nav-list" class="nav navbar-nav navbar-right">
            ...
            <li>
              <a href=index.html><i class="material-icons md-36 color">help</i></a>
            </li>
          </ul> 
        </div>
      </nav>
      	<div class="col-lg-2">
	      	<div class="input-group">
	            ...
	            <input id="name" class="form-control" type="text" placeholder="eg.13">
	         </div>
	    </div>
	    <div class="col-lg-1">
          <span class="input-group" "input-group-btn">
            
              <input class="btn btn-default" type="submit" id="name-submit" value="Search"></input>
              <!-- <a href= ajax/ajax.php></a> -->
          </span>
	    </div>
